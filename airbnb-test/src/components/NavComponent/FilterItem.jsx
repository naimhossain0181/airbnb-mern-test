...
const FilterItem = (props) => {
    ...
    return (
        ...
        <div className=" fixed z-50 bg-white w-[600px] overflow-scroll h-[500px] top-20 bottom-[50%] border-2">
            ...
            <div className=' fixed flex justify-around items-center border-2 bg-white text-white h-24 w-[600px] rounded-sm  bottom-0 '>
                ...
                <button className=' z-50 fixed left-[25%] top-20 w-12 h-8 bg-red-600 rounded-md text-white' onClick={()=>props.setShow(false)}>X</button>
            </div>
        </div>
    );
};
